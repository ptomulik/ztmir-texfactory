...
\begin{appendices}
  ...
  o~rzeczywistych współczynnikach $x_i$, $i=1,\dots,2n+1$:
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{equation}
    G(s) = \frac{x_{2n+1} s^n + x_{2n} s^{n-1} + \cdots + x_{n+2} s + x_{n+1}}
                {x_n s^n + x_{n-1} s^{n-1} + \cdots + x_1 s + 1}.
    \label{eq:Z0EFM}
  \end{equation}
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{equation}
      x_{2n+1} s^n + x_{2n} s^{n-1} + \cdots + x_{n+2} s + x_{n+1}
      = \left(
          x_n s^n + x_{n-1} s^{n-1} + \cdots + x_1 s + 1
  ...
  otrzymuje się układ równań liniowych $(2n+1) \times (2n+1)$ względem~$x_i$:
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{equation}
    \begin{aligned}
      x_{n+1} & = w_0 \\
    - w_0 x_1 + x_{n+2} & = w_1 \\
      \vdots  & \\
   -  w_{n-1} x_1 - w_{n-2} x_2 - \cdots - w_0 x_n + x_{2n+1} &= w_n \\
      - w_n x_1 - w_{n-1} x_2 - \cdots - w_1 x_n &=  w_{n+1} \\
      - w_{n+1} x_1 - w_n x_2 - \cdots - w_2 x_n & = w_{n+2} \\
      \vdots & \\
      - w_{2n-1} x_1 - w_{2n-2} x_2 - \cdots - w_n x_n & = w_{2n} \\
    \end{aligned}
    \label{eq:4LX5X}
  \end{equation}
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{equation}
    \mathbf{A}_n \cdot \mathbf{x}_n = \mathbf{w}_n,
    \label{eq:7CL5I}
  \end{equation}
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  gdzie
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{equation}
    G(s) = \frac{x_5 s^2 + x_4 s + x_3}{x_2 s^2 + x_1 s + 1}.
  \end{equation}
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \end{equation}
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  Oznaczmy jako $m_k$ poniższe wyrażenie
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{equation}
  ...
  \begin{equation}
    \begin{aligned}
      & m_k = \left[t^k h(t)\right]_0^{\infty} - k \int_0^{\infty}{t^{k-1} h(t) dt}, &
      & \text{dla } k=1, \dots &
    \end{aligned}
    \label{eq:MRW8Q}
  \end{equation}
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  Zakładając, że $|h(0)| < \infty$ oraz $|h(\infty)| < \infty$, możemy zapisać
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{equation}
  ...
  Ponieważ posługujemy się całkami niewłaściwymi, należy nadmienić, że istotną
  kwestią jest zapewnienie ich zbieżności. Przykładowo, wobec $h(t)=1/(1+t)$
  całka $m_2$ byłaby rozbieżna.
 ...
 \end{equation}
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{equation}
    M_k(T) = m \tau^{k-1} \int_0^{\tau m}{x^{k-1} \hat{h}(\tau x) dx}.
    \label{eq:R2WL9}
  \end{equation}
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

  W~dalszym postępowaniu przyjmujemy, że znane są jedynie dyskretne wartośći
  funkcji $\hat{h}(t)$ w~równomiernie rozmieszczonych punktach $t_i = \tau i$
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{equation}
    \begin{aligned}
  ...
  funkcji całkowanej $f(t) = t^{k-1} \hat{h}(t)$, to znaczy $f(\tau i) = f_i =
  (\tau i)^{k-1} \hat{h}_i$ dla $i=0,1,\dots,m$ (w~punktach próbkowania) oraz:
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{equation}
    f\left(\tau (i + \xi)\right) = f_i + \xi (f_{i+1} - f_i),
    \label{eq:CV1AT}
  \end{equation}
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  dla $\xi \in (0, 1)$, $i = 0, 1, \dots, m - 1$ (pomiędzy punktami, rysunek
  ~\ref{fig:Z319K}).
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{figure}[!ht]
    \centering
  ...
  \end{figure}
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  Całkę $M_k(T)$ aproksymuje się więc następująco
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{equation}
    M_k(T)
    \approx \sum_{i=0}^{m-1} {\int_0^1 {\left(f_i + \xi (f_{i+1} - f_i)\right) d\xi}}
    = \tau^{k-1} \left(
        \frac{m^{k-1} \hat{h}_m}{2} + \sum_{i=1}^{m-1} {i^{k-1} \hat{h}_i}
        \right).
    \label{eq:HNVFS}
  \end{equation}
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
